 ...
 47c:	89 d1                	mov    %edx,%ecx
{
 ...
 4a9:	0f b6 92 fc 0a 00 00 	movzbl 0xafc(%edx),%edx
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 599:	ff 24 85 a4 0a 00 00 	jmp    *0xaa4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6a7:	90                   	nop
          s = "(null)";
 6a8:	ba 9b 0a 00 00       	mov    $0xa9b,%edx
        while(*s != 0){
...
{
 850:	55                   	push   %ebp
 851:	b8 84 0e 00 00       	mov    $0xe84,%eax
 ...
 85b:	89 15 80 0e 00 00    	mov    %edx,0xe80
    for (mti=1; mti<N; mti++)
 861:	eb 08                	jmp    86b <sgenrand+0x1b>
 863:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 867:	90                   	nop
 868:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
 86b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
 871:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 873:	3d 3c 18 00 00       	cmp    $0x183c,%eax
 878:	75 ee                	jne    868 <sgenrand+0x18>
 87a:	c7 05 44 0e 00 00 70 	movl   $0x270,0xe44
 881:	02 00 00 
}
 884:	5d                   	pop    %ebp
 885:	c3                   	ret    
...
00000890 <genrand>:
{
 ...
 890:	a1 44 0e 00 00       	mov    0xe44,%eax
 895:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 89a:	7f 3d                	jg     8d9 <genrand+0x49>
    ...
    y = mt[mti++];
 89c:	8b 0c 85 80 0e 00 00 	mov    0xe80(,%eax,4),%ecx
 8a3:	8d 50 01             	lea    0x1(%eax),%edx
 8a6:	89 15 44 0e 00 00    	mov    %edx,0xe44
    y ^= TEMPERING_SHIFT_U(y);
 8ac:	89 ca                	mov    %ecx,%edx
 8ae:	c1 ea 0b             	shr    $0xb,%edx
 8b1:	31 ca                	xor    %ecx,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
 8b3:	89 d0                	mov    %edx,%eax
 8b5:	c1 e0 07             	shl    $0x7,%eax
 8b8:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
 8bd:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
 8bf:	89 c2                	mov    %eax,%edx
 8c1:	c1 e2 0f             	shl    $0xf,%edx
 8c4:	81 e2 00 00 c6 ef    	and    $0xefc60000,%edx
 8ca:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_L(y);
 8cc:	89 d0                	mov    %edx,%eax
 8ce:	c1 e8 12             	shr    $0x12,%eax
 8d1:	31 d0                	xor    %edx,%eax

    // Strip off uppermost bit because we want a long,
    // not an unsigned long
    return y & RAND_MAX;
 8d3:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
 8d8:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
 8d9:	3d 71 02 00 00       	cmp    $0x271,%eax
 8de:	0f 84 d4 00 00 00    	je     9b8 <genrand+0x128>
    mt[0]= seed & 0xffffffff;
 8e4:	31 c0                	xor    %eax,%eax
 8e6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8ed:	8d 76 00             	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 8f0:	8b 0c 85 80 0e 00 00 	mov    0xe80(,%eax,4),%ecx
 8f7:	83 c0 01             	add    $0x1,%eax
 8fa:	8b 14 85 80 0e 00 00 	mov    0xe80(,%eax,4),%edx
 ...
 914:	d1 e9                	shr    %ecx
 916:	33 0c 85 b0 14 00 00 	xor    0x14b0(,%eax,4),%ecx
 91d:	33 0c 95 10 0b 00 00 	xor    0xb10(,%edx,4),%ecx
 924:	89 0c 85 7c 0e 00 00 	mov    %ecx,0xe7c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 92b:	3d e3 00 00 00       	cmp    $0xe3,%eax
 930:	75 be                	jne    8f0 <genrand+0x60>
 932:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 938:	8b 0c 85 80 0e 00 00 	mov    0xe80(,%eax,4),%ecx
 93f:	83 c0 01             	add    $0x1,%eax
 942:	8b 14 85 80 0e 00 00 	mov    0xe80(,%eax,4),%edx
 ...
 95c:	d1 e9                	shr    %ecx
 95e:	33 0c 85 f0 0a 00 00 	xor    0xaf0(,%eax,4),%ecx
 965:	33 0c 95 10 0b 00 00 	xor    0xb10(,%edx,4),%ecx
 96c:	89 0c 85 7c 0e 00 00 	mov    %ecx,0xe7c(,%eax,4)
        for (;kk<N-1;kk++) {
 973:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 978:	75 be                	jne    938 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 97a:	8b 0d 80 0e 00 00    	mov    0xe80,%ecx
 980:	a1 3c 18 00 00       	mov    0x183c,%eax
 985:	89 ca                	mov    %ecx,%edx
 987:	25 00 00 00 80       	and    $0x80000000,%eax
 98c:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 992:	09 d0                	or     %edx,%eax
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
 994:	89 c2                	mov    %eax,%edx
 996:	83 e0 01             	and    $0x1,%eax
 999:	d1 ea                	shr    %edx
 99b:	33 15 b0 14 00 00    	xor    0x14b0,%edx
 9a1:	33 14 85 10 0b 00 00 	xor    0xb10(,%eax,4),%edx
 9a8:	89 15 3c 18 00 00    	mov    %edx,0x183c
 9ae:	ba 01 00 00 00       	mov    $0x1,%edx
 9b3:	e9 ee fe ff ff       	jmp    8a6 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 9b8:	b8 84 0e 00 00       	mov    $0xe84,%eax
 9bd:	b9 3c 18 00 00       	mov    $0x183c,%ecx
 9c2:	ba 05 11 00 00       	mov    $0x1105,%edx
 9c7:	c7 05 80 0e 00 00 05 	movl   $0x1105,0xe80
 9ce:	11 00 00 
    for (mti=1; mti<N; mti++)
 9d1:	eb 08                	jmp    9db <genrand+0x14b>
 ...
 9e7:	e9 f8 fe ff ff       	jmp    8e4 <genrand+0x54>
...
long random_at_most(long max) {
 9f9:	53                   	push   %ebx
    bin_size = num_rand / num_bins,
 9fa:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
 9ff:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 a02:	89 d8                	mov    %ebx,%eax
 a04:	f7 f1                	div    %ecx
 a06:	89 c6                	mov    %eax,%esi
  long x;
  do {
   x = genrand();
  }
...
int randomrange(int low, int high){
 ...
 a3c:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(high<low){
 a3f:	39 f0                	cmp    %esi,%eax
 a41:	7d 06                	jge    a49 <randomrange+0x19>
 a43:	89 f2                	mov    %esi,%edx
 ...
 a49:	29 f0                	sub    %esi,%eax
    bin_size = num_rand / num_bins,
 a4b:	bb 00 00 00 80       	mov    $0x80000000,%ebx
 a50:	31 d2                	xor    %edx,%edx
    num_bins = (unsigned long) max + 1,
 a52:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 a55:	89 d8                	mov    %ebx,%eax
 a57:	f7 f1                	div    %ecx
 a59:	89 c7                	mov    %eax,%edi
  while (num_rand - defect <= (unsigned long)x);
 a5b:	29 d3                	sub    %edx,%ebx
 a5d:	8d 76 00             	lea    0x0(%esi),%esi
   x = genrand();
 a60:	e8 2b fe ff ff       	call   890 <genrand>
  while (num_rand - defect <= (unsigned long)x);
 a65:	39 d8                	cmp    %ebx,%eax
 a67:	73 f7                	jae    a60 <randomrange+0x30>
  return x/bin_size;
 a69:	31 d2                	xor    %edx,%edx
  return val;
}
 a6b:	83 c4 0c             	add    $0xc,%esp
  return x/bin_size;
 a6e:	f7 f7                	div    %edi
}
 a70:	5b                   	pop    %ebx
  int val = random_at_most(high-low) + low;
 a71:	01 f0                	add    %esi,%eax
}
 a73:	5e                   	pop    %esi
 a74:	5f                   	pop    %edi
 a75:	5d                   	pop    %ebp
