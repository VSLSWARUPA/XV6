...
main(void){
  ...
  11:	68 88 09 00 00       	push   $0x988
  16:	6a 01                	push   $0x1
  18:	e8 13 04 00 00       	call   430 <printf>
	set_burst_time(5);
  1d:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  24:	e8 32 03 00 00       	call   35b <set_burst_time>
	printf(1, "Burst time is: %d\n", get_burst_time());
  29:	e8 35 03 00 00       	call   363 <get_burst_time>
  2e:	83 c4 0c             	add    $0xc,%esp
  31:	50                   	push   %eax
  32:	68 cf 09 00 00       	push   $0x9cf
  37:	6a 01                	push   $0x1
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 44 0a 00 00 	movzbl 0xa44(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 ec 09 00 00 	jmp    *0x9ec(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba e2 09 00 00       	mov    $0x9e2,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 80 0d 00 00       	mov    0xd80,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 80 0d 00 00    	mov    %edx,0xd80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 80 0d 00 00    	mov    0xd80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 80 0d 00 00    	mov    0xd80,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 80 0d 00 00    	mov    0xd80,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 80 0d 00 00 84 	movl   $0xd84,0xd80
 727:	0d 00 00 
    base.s.size = 0;
 72a:	bf 84 0d 00 00       	mov    $0xd84,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 84 0d 00 00 84 	movl   $0xd84,0xd84
 736:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 88 0d 00 00 00 	movl   $0x0,0xd88
 742:	00 00 00 
    if(p->s.size >= nunits){
...
{
 760:	55                   	push   %ebp
 761:	b8 a4 0d 00 00       	mov    $0xda4,%eax
 ...
 76b:	89 15 a0 0d 00 00    	mov    %edx,0xda0
    for (mti=1; mti<N; mti++)
 ...
 781:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 783:	3d 5c 17 00 00       	cmp    $0x175c,%eax
 788:	75 ee                	jne    778 <sgenrand+0x18>
 78a:	c7 05 7c 0d 00 00 70 	movl   $0x270,0xd7c
 791:	02 00 00 
}
 794:	5d                   	pop    %ebp
 795:	c3                   	ret    
...
000007a0 <genrand>:
{
 ...
 7a0:	a1 7c 0d 00 00       	mov    0xd7c,%eax
 ...
 7aa:	7f 3d                	jg     7e9 <genrand+0x49>
    ...
    y = mt[mti++];
 7ac:	8b 0c 85 a0 0d 00 00 	mov    0xda0(,%eax,4),%ecx
 7b3:	8d 50 01             	lea    0x1(%eax),%edx
 7b6:	89 15 7c 0d 00 00    	mov    %edx,0xd7c
 ...
 800:	8b 0c 85 a0 0d 00 00 	mov    0xda0(,%eax,4),%ecx
 807:	83 c0 01             	add    $0x1,%eax
 80a:	8b 14 85 a0 0d 00 00 	mov    0xda0(,%eax,4),%edx
 ...
 824:	d1 e9                	shr    %ecx
 826:	33 0c 85 d0 13 00 00 	xor    0x13d0(,%eax,4),%ecx
 82d:	33 0c 95 58 0a 00 00 	xor    0xa58(,%edx,4),%ecx
 834:	89 0c 85 9c 0d 00 00 	mov    %ecx,0xd9c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 83b:	3d e3 00 00 00       	cmp    $0xe3,%eax
 840:	75 be                	jne    800 <genrand+0x60>
 842:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 848:	8b 0c 85 a0 0d 00 00 	mov    0xda0(,%eax,4),%ecx
 84f:	83 c0 01             	add    $0x1,%eax
 852:	8b 14 85 a0 0d 00 00 	mov    0xda0(,%eax,4),%edx
 ...
 86c:	d1 e9                	shr    %ecx
 86e:	33 0c 85 10 0a 00 00 	xor    0xa10(,%eax,4),%ecx
 875:	33 0c 95 58 0a 00 00 	xor    0xa58(,%edx,4),%ecx
 87c:	89 0c 85 9c 0d 00 00 	mov    %ecx,0xd9c(,%eax,4)
        for (;kk<N-1;kk++) {
 883:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 888:	75 be                	jne    848 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 88a:	8b 0d a0 0d 00 00    	mov    0xda0,%ecx
 890:	a1 5c 17 00 00       	mov    0x175c,%eax
 ...
 8a9:	d1 ea                	shr    %edx
 8ab:	33 15 d0 13 00 00    	xor    0x13d0,%edx
 8b1:	33 14 85 58 0a 00 00 	xor    0xa58(,%eax,4),%edx
 8b8:	89 15 5c 17 00 00    	mov    %edx,0x175c
 8be:	ba 01 00 00 00       	mov    $0x1,%edx
 8c3:	e9 ee fe ff ff       	jmp    7b6 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 8c8:	b8 a4 0d 00 00       	mov    $0xda4,%eax
 8cd:	b9 5c 17 00 00       	mov    $0x175c,%ecx
 8d2:	ba 05 11 00 00       	mov    $0x1105,%edx
 8d7:	c7 05 a0 0d 00 00 05 	movl   $0x1105,0xda0
 8de:	11 00 00 
    for (mti=1; mti<N; mti++)
