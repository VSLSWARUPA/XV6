 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 e0 0a 00 00 	movzbl 0xae0(%edx),%edx
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 88 0a 00 00 	jmp    *0xa88(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 80 0a 00 00       	mov    $0xa80,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 60 10 00 00       	mov    0x1060,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 60 10 00 00    	mov    %edx,0x1060
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 60 10 00 00    	mov    %edx,0x1060
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 60 10 00 00    	mov    0x1060,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 60 10 00 00    	mov    0x1060,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 60 10 00 00    	mov    0x1060,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 60 10 00 00    	mov    %edx,0x1060
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 60 10 00 00 64 	movl   $0x1064,0x1060
 7e7:	10 00 00 
    base.s.size = 0;
 7ea:	bf 64 10 00 00       	mov    $0x1064,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 64 10 00 00 64 	movl   $0x1064,0x1064
 7f6:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 68 10 00 00 00 	movl   $0x0,0x1068
 802:	00 00 00 
    if(p->s.size >= nunits){
...
{
 820:	55                   	push   %ebp
 821:	b8 84 10 00 00       	mov    $0x1084,%eax
 ...
 82b:	89 15 80 10 00 00    	mov    %edx,0x1080
    for (mti=1; mti<N; mti++)
 ...
 841:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 843:	3d 3c 1a 00 00       	cmp    $0x1a3c,%eax
 848:	75 ee                	jne    838 <sgenrand+0x18>
 84a:	c7 05 54 0e 00 00 70 	movl   $0x270,0xe54
 851:	02 00 00 
}
 854:	5d                   	pop    %ebp
 855:	c3                   	ret    
...
00000860 <genrand>:
{
 ...
 860:	a1 54 0e 00 00       	mov    0xe54,%eax
 ...
 86a:	7f 3d                	jg     8a9 <genrand+0x49>
    ...
    y = mt[mti++];
 86c:	8b 0c 85 80 10 00 00 	mov    0x1080(,%eax,4),%ecx
 873:	8d 50 01             	lea    0x1(%eax),%edx
 876:	89 15 54 0e 00 00    	mov    %edx,0xe54
 ...
 8c0:	8b 0c 85 80 10 00 00 	mov    0x1080(,%eax,4),%ecx
 8c7:	83 c0 01             	add    $0x1,%eax
 8ca:	8b 14 85 80 10 00 00 	mov    0x1080(,%eax,4),%edx
 ...
 8e4:	d1 e9                	shr    %ecx
 8e6:	33 0c 85 b0 16 00 00 	xor    0x16b0(,%eax,4),%ecx
 8ed:	33 0c 95 f4 0a 00 00 	xor    0xaf4(,%edx,4),%ecx
 8f4:	89 0c 85 7c 10 00 00 	mov    %ecx,0x107c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 8fb:	3d e3 00 00 00       	cmp    $0xe3,%eax
 900:	75 be                	jne    8c0 <genrand+0x60>
 902:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 908:	8b 0c 85 80 10 00 00 	mov    0x1080(,%eax,4),%ecx
 90f:	83 c0 01             	add    $0x1,%eax
 912:	8b 14 85 80 10 00 00 	mov    0x1080(,%eax,4),%edx
 ...
 92c:	d1 e9                	shr    %ecx
 92e:	33 0c 85 f0 0c 00 00 	xor    0xcf0(,%eax,4),%ecx
 935:	33 0c 95 f4 0a 00 00 	xor    0xaf4(,%edx,4),%ecx
 93c:	89 0c 85 7c 10 00 00 	mov    %ecx,0x107c(,%eax,4)
        for (;kk<N-1;kk++) {
 943:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 948:	75 be                	jne    908 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 94a:	8b 0d 80 10 00 00    	mov    0x1080,%ecx
 950:	a1 3c 1a 00 00       	mov    0x1a3c,%eax
 ...
 969:	d1 ea                	shr    %edx
 96b:	33 15 b0 16 00 00    	xor    0x16b0,%edx
 971:	33 14 85 f4 0a 00 00 	xor    0xaf4(,%eax,4),%edx
 978:	89 15 3c 1a 00 00    	mov    %edx,0x1a3c
 97e:	ba 01 00 00 00       	mov    $0x1,%edx
 983:	e9 ee fe ff ff       	jmp    876 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 988:	b8 84 10 00 00       	mov    $0x1084,%eax
 98d:	b9 3c 1a 00 00       	mov    $0x1a3c,%ecx
 992:	ba 05 11 00 00       	mov    $0x1105,%edx
 997:	c7 05 80 10 00 00 05 	movl   $0x1105,0x1080
 99e:	11 00 00 
    for (mti=1; mti<N; mti++)
