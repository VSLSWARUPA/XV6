...
main(void){
  ...
  11:	e8 0d 03 00 00       	call   323 <getNumProc>
  16:	83 ec 04             	sub    $0x4,%esp
  19:	50                   	push   %eax
  1a:	68 68 09 00 00       	push   $0x968
  1f:	6a 01                	push   $0x1
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 fc 09 00 00 	movzbl 0x9fc(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 a4 09 00 00 	jmp    *0x9a4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 9c 09 00 00       	mov    $0x99c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 40 0d 00 00       	mov    0xd40,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 40 0d 00 00    	mov    %edx,0xd40
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 40 0d 00 00    	mov    %edx,0xd40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 40 0d 00 00    	mov    0xd40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 40 0d 00 00    	mov    0xd40,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 40 0d 00 00    	mov    0xd40,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 40 0d 00 00    	mov    %edx,0xd40
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 40 0d 00 00 44 	movl   $0xd44,0xd40
 707:	0d 00 00 
    base.s.size = 0;
 70a:	bf 44 0d 00 00       	mov    $0xd44,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 44 0d 00 00 44 	movl   $0xd44,0xd44
 716:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 48 0d 00 00 00 	movl   $0x0,0xd48
 722:	00 00 00 
    if(p->s.size >= nunits){
...
{
 740:	55                   	push   %ebp
 741:	b8 64 0d 00 00       	mov    $0xd64,%eax
 ...
 74b:	89 15 60 0d 00 00    	mov    %edx,0xd60
    for (mti=1; mti<N; mti++)
 751:	eb 08                	jmp    75b <sgenrand+0x1b>
 753:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 757:	90                   	nop
 758:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
 75b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
 761:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 763:	3d 1c 17 00 00       	cmp    $0x171c,%eax
 768:	75 ee                	jne    758 <sgenrand+0x18>
 76a:	c7 05 34 0d 00 00 70 	movl   $0x270,0xd34
 771:	02 00 00 
}
 774:	5d                   	pop    %ebp
 775:	c3                   	ret    
...
00000780 <genrand>:
{
 ...
 780:	a1 34 0d 00 00       	mov    0xd34,%eax
 785:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 78a:	7f 3d                	jg     7c9 <genrand+0x49>
    ...
    y = mt[mti++];
 78c:	8b 0c 85 60 0d 00 00 	mov    0xd60(,%eax,4),%ecx
 793:	8d 50 01             	lea    0x1(%eax),%edx
 796:	89 15 34 0d 00 00    	mov    %edx,0xd34
    y ^= TEMPERING_SHIFT_U(y);
 79c:	89 ca                	mov    %ecx,%edx
 79e:	c1 ea 0b             	shr    $0xb,%edx
 7a1:	31 ca                	xor    %ecx,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
 7a3:	89 d0                	mov    %edx,%eax
 7a5:	c1 e0 07             	shl    $0x7,%eax
 7a8:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
 7ad:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
 7af:	89 c2                	mov    %eax,%edx
 7b1:	c1 e2 0f             	shl    $0xf,%edx
 7b4:	81 e2 00 00 c6 ef    	and    $0xefc60000,%edx
 7ba:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_L(y);
 7bc:	89 d0                	mov    %edx,%eax
 7be:	c1 e8 12             	shr    $0x12,%eax
 7c1:	31 d0                	xor    %edx,%eax

    // Strip off uppermost bit because we want a long,
    // not an unsigned long
    return y & RAND_MAX;
 7c3:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
 7c8:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
 7c9:	3d 71 02 00 00       	cmp    $0x271,%eax
 7ce:	0f 84 d4 00 00 00    	je     8a8 <genrand+0x128>
    mt[0]= seed & 0xffffffff;
 7d4:	31 c0                	xor    %eax,%eax
 7d6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 7dd:	8d 76 00             	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 7e0:	8b 0c 85 60 0d 00 00 	mov    0xd60(,%eax,4),%ecx
 7e7:	83 c0 01             	add    $0x1,%eax
 7ea:	8b 14 85 60 0d 00 00 	mov    0xd60(,%eax,4),%edx
 7f1:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
 7f7:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 7fd:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
 7ff:	89 d1                	mov    %edx,%ecx
 801:	83 e2 01             	and    $0x1,%edx
 804:	d1 e9                	shr    %ecx
 806:	33 0c 85 90 13 00 00 	xor    0x1390(,%eax,4),%ecx
 80d:	33 0c 95 10 0a 00 00 	xor    0xa10(,%edx,4),%ecx
 814:	89 0c 85 5c 0d 00 00 	mov    %ecx,0xd5c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 81b:	3d e3 00 00 00       	cmp    $0xe3,%eax
 820:	75 be                	jne    7e0 <genrand+0x60>
 822:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 828:	8b 0c 85 60 0d 00 00 	mov    0xd60(,%eax,4),%ecx
 82f:	83 c0 01             	add    $0x1,%eax
 832:	8b 14 85 60 0d 00 00 	mov    0xd60(,%eax,4),%edx
 839:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
 83f:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 845:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
 847:	89 d1                	mov    %edx,%ecx
 849:	83 e2 01             	and    $0x1,%edx
 84c:	d1 e9                	shr    %ecx
 84e:	33 0c 85 d0 09 00 00 	xor    0x9d0(,%eax,4),%ecx
 855:	33 0c 95 10 0a 00 00 	xor    0xa10(,%edx,4),%ecx
 85c:	89 0c 85 5c 0d 00 00 	mov    %ecx,0xd5c(,%eax,4)
        for (;kk<N-1;kk++) {
 863:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 868:	75 be                	jne    828 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 86a:	8b 0d 60 0d 00 00    	mov    0xd60,%ecx
 870:	a1 1c 17 00 00       	mov    0x171c,%eax
 875:	89 ca                	mov    %ecx,%edx
 877:	25 00 00 00 80       	and    $0x80000000,%eax
 87c:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 882:	09 d0                	or     %edx,%eax
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
 884:	89 c2                	mov    %eax,%edx
 886:	83 e0 01             	and    $0x1,%eax
 889:	d1 ea                	shr    %edx
 88b:	33 15 90 13 00 00    	xor    0x1390,%edx
 891:	33 14 85 10 0a 00 00 	xor    0xa10(,%eax,4),%edx
 898:	89 15 1c 17 00 00    	mov    %edx,0x171c
 89e:	ba 01 00 00 00       	mov    $0x1,%edx
 8a3:	e9 ee fe ff ff       	jmp    796 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 8a8:	b8 64 0d 00 00       	mov    $0xd64,%eax
 8ad:	b9 1c 17 00 00       	mov    $0x171c,%ecx
 8b2:	ba 05 11 00 00       	mov    $0x1105,%edx
 8b7:	c7 05 60 0d 00 00 05 	movl   $0x1105,0xd60
 8be:	11 00 00 
    for (mti=1; mti<N; mti++)
 8c1:	eb 08                	jmp    8cb <genrand+0x14b>
 ...
 8d1:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 8d3:	39 c1                	cmp    %eax,%ecx
 8d5:	75 f1                	jne    8c8 <genrand+0x148>
 8d7:	e9 f8 fe ff ff       	jmp    7d4 <genrand+0x54>
 8dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

000008e0 <random_at_most>:
...
long random_at_most(long max) {
 8e9:	53                   	push   %ebx
    bin_size = num_rand / num_bins,
 8ea:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
 8ef:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 ...
 8f8:	29 d3                	sub    %edx,%ebx
 8fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
   x = genrand();
 900:	e8 7b fe ff ff       	call   780 <genrand>
  while (num_rand - defect <= (unsigned long)x);
 905:	39 d8                	cmp    %ebx,%eax
 907:	73 f7                	jae    900 <random_at_most+0x20>
...
int randomrange(int low, int high){
 ...
 92c:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(high<low){
 92f:	39 f0                	cmp    %esi,%eax
 931:	7d 06                	jge    939 <randomrange+0x19>
 933:	89 f2                	mov    %esi,%edx
 935:	89 c6                	mov    %eax,%esi
 ...
 939:	29 f0                	sub    %esi,%eax
    bin_size = num_rand / num_bins,
 93b:	bb 00 00 00 80       	mov    $0x80000000,%ebx
 940:	31 d2                	xor    %edx,%edx
    num_bins = (unsigned long) max + 1,
 942:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 945:	89 d8                	mov    %ebx,%eax
 947:	f7 f1                	div    %ecx
 949:	89 c7                	mov    %eax,%edi
  while (num_rand - defect <= (unsigned long)x);
 94b:	29 d3                	sub    %edx,%ebx
 94d:	8d 76 00             	lea    0x0(%esi),%esi
   x = genrand();
 950:	e8 2b fe ff ff       	call   780 <genrand>
  while (num_rand - defect <= (unsigned long)x);
 955:	39 d8                	cmp    %ebx,%eax
 957:	73 f7                	jae    950 <randomrange+0x30>
  return x/bin_size;
 959:	31 d2                	xor    %edx,%edx
  return val;
}
 95b:	83 c4 0c             	add    $0xc,%esp
  return x/bin_size;
 95e:	f7 f7                	div    %edi
}
 960:	5b                   	pop    %ebx
  int val = random_at_most(high-low) + low;
 961:	01 f0                	add    %esi,%eax
}
 963:	5e                   	pop    %esi
 964:	5f                   	pop    %edi
 965:	5d                   	pop    %ebp
