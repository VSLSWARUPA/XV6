...
00000060 <fmtname>:
{
  ...
  db:	05 00 11 00 00       	add    $0x1100,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
 ...
 67c:	89 d1                	mov    %edx,%ecx
{
 ...
 6a9:	0f b6 92 24 0d 00 00 	movzbl 0xd24(%edx),%edx
 ...
 729:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 799:	ff 24 85 cc 0c 00 00 	jmp    *0xccc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8a7:	90                   	nop
          s = "(null)";
 8a8:	ba c2 0c 00 00       	mov    $0xcc2,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8c1:	a1 10 11 00 00       	mov    0x1110,%eax
{
 ...
 901:	5b                   	pop    %ebx
  freep = p;
 902:	89 15 10 11 00 00    	mov    %edx,0x1110
}
 908:	5e                   	pop    %esi
 909:	5f                   	pop    %edi
 90a:	5d                   	pop    %ebp
 ...
 939:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 93c:	89 15 10 11 00 00    	mov    %edx,0x1110
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 95c:	8b 3d 10 11 00 00    	mov    0x1110,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 99f:	73 4f                	jae    9f0 <malloc+0xa0>
    ...
    if(p == freep)
 9a1:	8b 3d 10 11 00 00    	mov    0x1110,%edi
 ...
 9ca:	e8 f1 fe ff ff       	call   8c0 <free>
  return freep;
 9cf:	8b 15 10 11 00 00    	mov    0x1110,%edx
 ...
 9fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9ff:	89 15 10 11 00 00    	mov    %edx,0x1110
}
 ...
 a0f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a10:	c7 05 10 11 00 00 14 	movl   $0x1114,0x1110
 a17:	11 00 00 
    base.s.size = 0;
 a1a:	bf 14 11 00 00       	mov    $0x1114,%edi
    base.s.ptr = freep = prevp = &base;
 a1f:	c7 05 14 11 00 00 14 	movl   $0x1114,0x1114
 a26:	11 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a29:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a2b:	c7 05 18 11 00 00 00 	movl   $0x0,0x1118
 a32:	00 00 00 
    if(p->s.size >= nunits){
...
{
 a50:	55                   	push   %ebp
 a51:	b8 24 11 00 00       	mov    $0x1124,%eax
 ...
 a5b:	89 15 20 11 00 00    	mov    %edx,0x1120
    for (mti=1; mti<N; mti++)
 a61:	eb 08                	jmp    a6b <sgenrand+0x1b>
 ...
 a71:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 a73:	3d dc 1a 00 00       	cmp    $0x1adc,%eax
 a78:	75 ee                	jne    a68 <sgenrand+0x18>
 a7a:	c7 05 e4 10 00 00 70 	movl   $0x270,0x10e4
 a81:	02 00 00 
}
 a84:	5d                   	pop    %ebp
 a85:	c3                   	ret    
...
00000a90 <genrand>:
{
 ...
 a90:	a1 e4 10 00 00       	mov    0x10e4,%eax
 a95:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 a9a:	7f 3d                	jg     ad9 <genrand+0x49>
    ...
    y = mt[mti++];
 a9c:	8b 0c 85 20 11 00 00 	mov    0x1120(,%eax,4),%ecx
 aa3:	8d 50 01             	lea    0x1(%eax),%edx
 aa6:	89 15 e4 10 00 00    	mov    %edx,0x10e4
    y ^= TEMPERING_SHIFT_U(y);
 aac:	89 ca                	mov    %ecx,%edx
 aae:	c1 ea 0b             	shr    $0xb,%edx
 ab1:	31 ca                	xor    %ecx,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
 ab3:	89 d0                	mov    %edx,%eax
 ab5:	c1 e0 07             	shl    $0x7,%eax
 ab8:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
 abd:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
 abf:	89 c2                	mov    %eax,%edx
 ac1:	c1 e2 0f             	shl    $0xf,%edx
 ac4:	81 e2 00 00 c6 ef    	and    $0xefc60000,%edx
 aca:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_L(y);
 acc:	89 d0                	mov    %edx,%eax
 ace:	c1 e8 12             	shr    $0x12,%eax
 ad1:	31 d0                	xor    %edx,%eax

    // Strip off uppermost bit because we want a long,
    // not an unsigned long
    return y & RAND_MAX;
 ad3:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
 ad8:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
 ad9:	3d 71 02 00 00       	cmp    $0x271,%eax
 ade:	0f 84 d4 00 00 00    	je     bb8 <genrand+0x128>
    mt[0]= seed & 0xffffffff;
 ae4:	31 c0                	xor    %eax,%eax
 ae6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 aed:	8d 76 00             	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 af0:	8b 0c 85 20 11 00 00 	mov    0x1120(,%eax,4),%ecx
 af7:	83 c0 01             	add    $0x1,%eax
 afa:	8b 14 85 20 11 00 00 	mov    0x1120(,%eax,4),%edx
 b01:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
 b07:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 b0d:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
 b0f:	89 d1                	mov    %edx,%ecx
 b11:	83 e2 01             	and    $0x1,%edx
 b14:	d1 e9                	shr    %ecx
 b16:	33 0c 85 50 17 00 00 	xor    0x1750(,%eax,4),%ecx
 b1d:	33 0c 95 38 0d 00 00 	xor    0xd38(,%edx,4),%ecx
 b24:	89 0c 85 1c 11 00 00 	mov    %ecx,0x111c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 b2b:	3d e3 00 00 00       	cmp    $0xe3,%eax
 b30:	75 be                	jne    af0 <genrand+0x60>
 b32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 b38:	8b 0c 85 20 11 00 00 	mov    0x1120(,%eax,4),%ecx
 b3f:	83 c0 01             	add    $0x1,%eax
 b42:	8b 14 85 20 11 00 00 	mov    0x1120(,%eax,4),%edx
 b49:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
 b4f:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 b55:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
 b57:	89 d1                	mov    %edx,%ecx
 b59:	83 e2 01             	and    $0x1,%edx
 b5c:	d1 e9                	shr    %ecx
 b5e:	33 0c 85 90 0d 00 00 	xor    0xd90(,%eax,4),%ecx
 b65:	33 0c 95 38 0d 00 00 	xor    0xd38(,%edx,4),%ecx
 b6c:	89 0c 85 1c 11 00 00 	mov    %ecx,0x111c(,%eax,4)
        for (;kk<N-1;kk++) {
 b73:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 b78:	75 be                	jne    b38 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 b7a:	8b 0d 20 11 00 00    	mov    0x1120,%ecx
 b80:	a1 dc 1a 00 00       	mov    0x1adc,%eax
 b85:	89 ca                	mov    %ecx,%edx
 b87:	25 00 00 00 80       	and    $0x80000000,%eax
 b8c:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 b92:	09 d0                	or     %edx,%eax
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
 b94:	89 c2                	mov    %eax,%edx
 b96:	83 e0 01             	and    $0x1,%eax
 b99:	d1 ea                	shr    %edx
 b9b:	33 15 50 17 00 00    	xor    0x1750,%edx
 ba1:	33 14 85 38 0d 00 00 	xor    0xd38(,%eax,4),%edx
 ba8:	89 15 dc 1a 00 00    	mov    %edx,0x1adc
 bae:	ba 01 00 00 00       	mov    $0x1,%edx
 bb3:	e9 ee fe ff ff       	jmp    aa6 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 bb8:	b8 24 11 00 00       	mov    $0x1124,%eax
 bbd:	b9 dc 1a 00 00       	mov    $0x1adc,%ecx
 bc2:	ba 05 11 00 00       	mov    $0x1105,%edx
 bc7:	c7 05 20 11 00 00 05 	movl   $0x1105,0x1120
 bce:	11 00 00 
    for (mti=1; mti<N; mti++)
 bd1:	eb 08                	jmp    bdb <genrand+0x14b>
 bd3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 bd7:	90                   	nop
 bd8:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
 bdb:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
 be1:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 be3:	39 c1                	cmp    %eax,%ecx
 be5:	75 f1                	jne    bd8 <genrand+0x148>
 be7:	e9 f8 fe ff ff       	jmp    ae4 <genrand+0x54>
 bec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

00000bf0 <random_at_most>:
...
long random_at_most(long max) {
 bf9:	53                   	push   %ebx
    bin_size = num_rand / num_bins,
 bfa:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
 bff:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 c02:	89 d8                	mov    %ebx,%eax
 c04:	f7 f1                	div    %ecx
 ...
 c08:	29 d3                	sub    %edx,%ebx
 c0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
   x = genrand();
 c10:	e8 7b fe ff ff       	call   a90 <genrand>
  while (num_rand - defect <= (unsigned long)x);
 c15:	39 d8                	cmp    %ebx,%eax
 c17:	73 f7                	jae    c10 <random_at_most+0x20>

  // Truncated division is intentional
  return x/bin_size;
 c19:	31 d2                	xor    %edx,%edx
}
 c1b:	5b                   	pop    %ebx
  return x/bin_size;
 c1c:	f7 f6                	div    %esi
...
int randomrange(int low, int high){
 ...
 c3c:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(high<low){
 c3f:	39 f0                	cmp    %esi,%eax
 c41:	7d 06                	jge    c49 <randomrange+0x19>
 c43:	89 f2                	mov    %esi,%edx
 c45:	89 c6                	mov    %eax,%esi
 ...
 c49:	29 f0                	sub    %esi,%eax
    bin_size = num_rand / num_bins,
 c4b:	bb 00 00 00 80       	mov    $0x80000000,%ebx
 c50:	31 d2                	xor    %edx,%edx
    num_bins = (unsigned long) max + 1,
 c52:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 c55:	89 d8                	mov    %ebx,%eax
 c57:	f7 f1                	div    %ecx
 c59:	89 c7                	mov    %eax,%edi
  while (num_rand - defect <= (unsigned long)x);
 c5b:	29 d3                	sub    %edx,%ebx
 c5d:	8d 76 00             	lea    0x0(%esi),%esi
   x = genrand();
 c60:	e8 2b fe ff ff       	call   a90 <genrand>
  while (num_rand - defect <= (unsigned long)x);
 c65:	39 d8                	cmp    %ebx,%eax
 c67:	73 f7                	jae    c60 <randomrange+0x30>
  return x/bin_size;
 c69:	31 d2                	xor    %edx,%edx
  return val;
}
 c6b:	83 c4 0c             	add    $0xc,%esp
  return x/bin_size;
 c6e:	f7 f7                	div    %edi
}
 c70:	5b                   	pop    %ebx
  int val = random_at_most(high-low) + low;
 c71:	01 f0                	add    %esi,%eax
}
 c73:	5e                   	pop    %esi
 c74:	5f                   	pop    %edi
 c75:	5d                   	pop    %ebp
