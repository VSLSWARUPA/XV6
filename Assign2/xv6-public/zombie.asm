 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 c8 09 00 00 	movzbl 0x9c8(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 70 09 00 00 	jmp    *0x970(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 68 09 00 00       	mov    $0x968,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 20 0d 00 00       	mov    0xd20,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 20 0d 00 00    	mov    %edx,0xd20
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 20 0d 00 00    	mov    %edx,0xd20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 20 0d 00 00    	mov    0xd20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 20 0d 00 00    	mov    0xd20,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 20 0d 00 00    	mov    0xd20,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 20 0d 00 00    	mov    %edx,0xd20
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 20 0d 00 00 24 	movl   $0xd24,0xd20
 707:	0d 00 00 
    base.s.size = 0;
 70a:	bf 24 0d 00 00       	mov    $0xd24,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 24 0d 00 00 24 	movl   $0xd24,0xd24
 716:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 28 0d 00 00 00 	movl   $0x0,0xd28
 722:	00 00 00 
    if(p->s.size >= nunits){
...
{
 740:	55                   	push   %ebp
 741:	b8 44 0d 00 00       	mov    $0xd44,%eax
 ...
 74b:	89 15 40 0d 00 00    	mov    %edx,0xd40
    for (mti=1; mti<N; mti++)
 ...
 761:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 763:	3d fc 16 00 00       	cmp    $0x16fc,%eax
 768:	75 ee                	jne    758 <sgenrand+0x18>
 76a:	c7 05 00 0d 00 00 70 	movl   $0x270,0xd00
 771:	02 00 00 
}
 774:	5d                   	pop    %ebp
 775:	c3                   	ret    
...
00000780 <genrand>:
{
 ...
 780:	a1 00 0d 00 00       	mov    0xd00,%eax
 ...
 78a:	7f 3d                	jg     7c9 <genrand+0x49>
    ...
    y = mt[mti++];
 78c:	8b 0c 85 40 0d 00 00 	mov    0xd40(,%eax,4),%ecx
 793:	8d 50 01             	lea    0x1(%eax),%edx
 796:	89 15 00 0d 00 00    	mov    %edx,0xd00
 ...
 7e0:	8b 0c 85 40 0d 00 00 	mov    0xd40(,%eax,4),%ecx
 7e7:	83 c0 01             	add    $0x1,%eax
 7ea:	8b 14 85 40 0d 00 00 	mov    0xd40(,%eax,4),%edx
 ...
 804:	d1 e9                	shr    %ecx
 806:	33 0c 85 70 13 00 00 	xor    0x1370(,%eax,4),%ecx
 80d:	33 0c 95 dc 09 00 00 	xor    0x9dc(,%edx,4),%ecx
 814:	89 0c 85 3c 0d 00 00 	mov    %ecx,0xd3c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 81b:	3d e3 00 00 00       	cmp    $0xe3,%eax
 820:	75 be                	jne    7e0 <genrand+0x60>
 822:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 828:	8b 0c 85 40 0d 00 00 	mov    0xd40(,%eax,4),%ecx
 82f:	83 c0 01             	add    $0x1,%eax
 832:	8b 14 85 40 0d 00 00 	mov    0xd40(,%eax,4),%edx
 ...
 84c:	d1 e9                	shr    %ecx
 84e:	33 0c 85 b0 09 00 00 	xor    0x9b0(,%eax,4),%ecx
 855:	33 0c 95 dc 09 00 00 	xor    0x9dc(,%edx,4),%ecx
 85c:	89 0c 85 3c 0d 00 00 	mov    %ecx,0xd3c(,%eax,4)
        for (;kk<N-1;kk++) {
 863:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 868:	75 be                	jne    828 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 86a:	8b 0d 40 0d 00 00    	mov    0xd40,%ecx
 870:	a1 fc 16 00 00       	mov    0x16fc,%eax
 ...
 889:	d1 ea                	shr    %edx
 88b:	33 15 70 13 00 00    	xor    0x1370,%edx
 891:	33 14 85 dc 09 00 00 	xor    0x9dc(,%eax,4),%edx
 898:	89 15 fc 16 00 00    	mov    %edx,0x16fc
 89e:	ba 01 00 00 00       	mov    $0x1,%edx
 8a3:	e9 ee fe ff ff       	jmp    796 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 8a8:	b8 44 0d 00 00       	mov    $0xd44,%eax
 8ad:	b9 fc 16 00 00       	mov    $0x16fc,%ecx
 8b2:	ba 05 11 00 00       	mov    $0x1105,%edx
 8b7:	c7 05 40 0d 00 00 05 	movl   $0x1105,0xd40
 8be:	11 00 00 
    for (mti=1; mti<N; mti++)
