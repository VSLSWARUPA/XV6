...
main(void){
  ...
  11:	e8 15 03 00 00       	call   32b <getMaxPID>
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 04 0a 00 00 	movzbl 0xa04(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 ac 09 00 00 	jmp    *0x9ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba a5 09 00 00       	mov    $0x9a5,%edx
        while(*s != 0){
...
sgenrand(unsigned long seed)
{
 ...
 76a:	c7 05 3c 0d 00 00 70 	movl   $0x270,0xd3c
 771:	02 00 00 
}
 774:	5d                   	pop    %ebp
 775:	c3                   	ret    
...
00000780 <genrand>:
{
 ...
 780:	a1 3c 0d 00 00       	mov    0xd3c,%eax
 ...
 796:	89 15 3c 0d 00 00    	mov    %edx,0xd3c
 ...
 80d:	33 0c 95 18 0a 00 00 	xor    0xa18(,%edx,4),%ecx
 ...
 855:	33 0c 95 18 0a 00 00 	xor    0xa18(,%edx,4),%ecx
 ...
 891:	33 14 85 18 0a 00 00 	xor    0xa18(,%eax,4),%edx
