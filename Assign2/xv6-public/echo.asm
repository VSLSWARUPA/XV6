...
main(int argc, char *argv[])
{
  ...
  2e:	66 90                	xchg   %ax,%ax
  30:	68 a8 09 00 00       	push   $0x9a8
  35:	83 c3 01             	add    $0x1,%ebx
  38:	50                   	push   %eax
  39:	68 aa 09 00 00       	push   $0x9aa
  3e:	6a 01                	push   $0x1
  ...
  50:	68 af 09 00 00       	push   $0x9af
  55:	50                   	push   %eax
  56:	68 aa 09 00 00       	push   $0x9aa
  5b:	6a 01                	push   $0x1
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 10 0a 00 00 	movzbl 0xa10(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 b8 09 00 00 	jmp    *0x9b8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba b1 09 00 00       	mov    $0x9b1,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 60 0d 00 00       	mov    0xd60,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 60 0d 00 00    	mov    %edx,0xd60
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 60 0d 00 00    	mov    %edx,0xd60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 60 0d 00 00    	mov    0xd60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d 60 0d 00 00    	mov    0xd60,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 60 0d 00 00    	mov    0xd60,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 60 0d 00 00    	mov    %edx,0xd60
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 60 0d 00 00 64 	movl   $0xd64,0xd60
 747:	0d 00 00 
    base.s.size = 0;
 74a:	bf 64 0d 00 00       	mov    $0xd64,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 64 0d 00 00 64 	movl   $0xd64,0xd64
 756:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 68 0d 00 00 00 	movl   $0x0,0xd68
 762:	00 00 00 
    if(p->s.size >= nunits){
...
{
 780:	55                   	push   %ebp
 781:	b8 84 0d 00 00       	mov    $0xd84,%eax
 ...
 78b:	89 15 80 0d 00 00    	mov    %edx,0xd80
    for (mti=1; mti<N; mti++)
 ...
 7a1:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 7a3:	3d 3c 17 00 00       	cmp    $0x173c,%eax
 7a8:	75 ee                	jne    798 <sgenrand+0x18>
 7aa:	c7 05 54 0d 00 00 70 	movl   $0x270,0xd54
 7b1:	02 00 00 
}
 7b4:	5d                   	pop    %ebp
 7b5:	c3                   	ret    
...
000007c0 <genrand>:
{
 ...
 7c0:	a1 54 0d 00 00       	mov    0xd54,%eax
 ...
 7ca:	7f 3d                	jg     809 <genrand+0x49>
    ...
    y = mt[mti++];
 7cc:	8b 0c 85 80 0d 00 00 	mov    0xd80(,%eax,4),%ecx
 7d3:	8d 50 01             	lea    0x1(%eax),%edx
 7d6:	89 15 54 0d 00 00    	mov    %edx,0xd54
 ...
 820:	8b 0c 85 80 0d 00 00 	mov    0xd80(,%eax,4),%ecx
 827:	83 c0 01             	add    $0x1,%eax
 82a:	8b 14 85 80 0d 00 00 	mov    0xd80(,%eax,4),%edx
 ...
 844:	d1 e9                	shr    %ecx
 846:	33 0c 85 b0 13 00 00 	xor    0x13b0(,%eax,4),%ecx
 84d:	33 0c 95 24 0a 00 00 	xor    0xa24(,%edx,4),%ecx
 854:	89 0c 85 7c 0d 00 00 	mov    %ecx,0xd7c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 85b:	3d e3 00 00 00       	cmp    $0xe3,%eax
 860:	75 be                	jne    820 <genrand+0x60>
 862:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 868:	8b 0c 85 80 0d 00 00 	mov    0xd80(,%eax,4),%ecx
 86f:	83 c0 01             	add    $0x1,%eax
 872:	8b 14 85 80 0d 00 00 	mov    0xd80(,%eax,4),%edx
 ...
 88c:	d1 e9                	shr    %ecx
 88e:	33 0c 85 f0 09 00 00 	xor    0x9f0(,%eax,4),%ecx
 895:	33 0c 95 24 0a 00 00 	xor    0xa24(,%edx,4),%ecx
 89c:	89 0c 85 7c 0d 00 00 	mov    %ecx,0xd7c(,%eax,4)
        for (;kk<N-1;kk++) {
 8a3:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 8a8:	75 be                	jne    868 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 8aa:	8b 0d 80 0d 00 00    	mov    0xd80,%ecx
 8b0:	a1 3c 17 00 00       	mov    0x173c,%eax
 ...
 8c9:	d1 ea                	shr    %edx
 8cb:	33 15 b0 13 00 00    	xor    0x13b0,%edx
 8d1:	33 14 85 24 0a 00 00 	xor    0xa24(,%eax,4),%edx
 8d8:	89 15 3c 17 00 00    	mov    %edx,0x173c
 8de:	ba 01 00 00 00       	mov    $0x1,%edx
 8e3:	e9 ee fe ff ff       	jmp    7d6 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 8e8:	b8 84 0d 00 00       	mov    $0xd84,%eax
 8ed:	b9 3c 17 00 00       	mov    $0x173c,%ecx
 8f2:	ba 05 11 00 00       	mov    $0x1105,%edx
 8f7:	c7 05 80 0d 00 00 05 	movl   $0x1105,0xd80
 8fe:	11 00 00 
    for (mti=1; mti<N; mti++)
