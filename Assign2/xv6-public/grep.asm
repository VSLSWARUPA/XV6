...
000001d0 <grep>:
{
 ...
 1fd:	50                   	push   %eax
 1fe:	8d 81 80 11 00 00    	lea    0x1180(%ecx),%eax
 204:	50                   	push   %eax
 ...
 21b:	8b 4d dc             	mov    -0x24(%ebp),%ecx
    p = buf;
 21e:	c7 45 e4 80 11 00 00 	movl   $0x1180,-0x1c(%ebp)
    buf[m] = '\0';
 225:	c6 81 80 11 00 00 00 	movb   $0x0,0x1180(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2bb:	81 fa 80 11 00 00    	cmp    $0x1180,%edx
 ...
 2d0:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2d3:	2d 80 11 00 00       	sub    $0x1180,%eax
 2d8:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
 2da:	51                   	push   %ecx
 2db:	52                   	push   %edx
 2dc:	68 80 11 00 00       	push   $0x1180
      m -= p - buf;
 ...
 6ac:	89 d1                	mov    %edx,%ecx
{
 ...
 6d9:	0f b6 92 40 0d 00 00 	movzbl 0xd40(%edx),%edx
 ...
 759:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7c9:	ff 24 85 e8 0c 00 00 	jmp    *0xce8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8d7:	90                   	nop
          s = "(null)";
 8d8:	ba de 0c 00 00       	mov    $0xcde,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8f1:	a1 80 15 00 00       	mov    0x1580,%eax
{
 ...
 931:	5b                   	pop    %ebx
  freep = p;
 932:	89 15 80 15 00 00    	mov    %edx,0x1580
}
 938:	5e                   	pop    %esi
 939:	5f                   	pop    %edi
 93a:	5d                   	pop    %ebp
 ...
 969:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 96c:	89 15 80 15 00 00    	mov    %edx,0x1580
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 989:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 98c:	8b 3d 80 15 00 00    	mov    0x1580,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9cf:	73 4f                	jae    a20 <malloc+0xa0>
    ...
    if(p == freep)
 9d1:	8b 3d 80 15 00 00    	mov    0x1580,%edi
 ...
 9fa:	e8 f1 fe ff ff       	call   8f0 <free>
  return freep;
 9ff:	8b 15 80 15 00 00    	mov    0x1580,%edx
 ...
 a2c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a2f:	89 15 80 15 00 00    	mov    %edx,0x1580
}
 ...
 a3f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a40:	c7 05 80 15 00 00 84 	movl   $0x1584,0x1580
 a47:	15 00 00 
    base.s.size = 0;
 a4a:	bf 84 15 00 00       	mov    $0x1584,%edi
    base.s.ptr = freep = prevp = &base;
 a4f:	c7 05 84 15 00 00 84 	movl   $0x1584,0x1584
 a56:	15 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a59:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a5b:	c7 05 88 15 00 00 00 	movl   $0x0,0x1588
 a62:	00 00 00 
    if(p->s.size >= nunits){
...
{
 a80:	55                   	push   %ebp
 a81:	b8 a4 15 00 00       	mov    $0x15a4,%eax
 ...
 a8b:	89 15 a0 15 00 00    	mov    %edx,0x15a0
    for (mti=1; mti<N; mti++)
 a91:	eb 08                	jmp    a9b <sgenrand+0x1b>
 ...
 aa1:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 aa3:	3d 5c 1f 00 00       	cmp    $0x1f5c,%eax
 aa8:	75 ee                	jne    a98 <sgenrand+0x18>
 aaa:	c7 05 70 11 00 00 70 	movl   $0x270,0x1170
 ab1:	02 00 00 
}
 ab4:	5d                   	pop    %ebp
 ab5:	c3                   	ret    
...
00000ac0 <genrand>:
{
 ...
 ac0:	a1 70 11 00 00       	mov    0x1170,%eax
 ac5:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 aca:	7f 3d                	jg     b09 <genrand+0x49>
    ...
    y = mt[mti++];
 acc:	8b 0c 85 a0 15 00 00 	mov    0x15a0(,%eax,4),%ecx
 ad3:	8d 50 01             	lea    0x1(%eax),%edx
 ad6:	89 15 70 11 00 00    	mov    %edx,0x1170
    y ^= TEMPERING_SHIFT_U(y);
 adc:	89 ca                	mov    %ecx,%edx
 ade:	c1 ea 0b             	shr    $0xb,%edx
 ae1:	31 ca                	xor    %ecx,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
 ae3:	89 d0                	mov    %edx,%eax
 ae5:	c1 e0 07             	shl    $0x7,%eax
 ae8:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
 aed:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
 aef:	89 c2                	mov    %eax,%edx
 af1:	c1 e2 0f             	shl    $0xf,%edx
 af4:	81 e2 00 00 c6 ef    	and    $0xefc60000,%edx
 afa:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_L(y);
 afc:	89 d0                	mov    %edx,%eax
 afe:	c1 e8 12             	shr    $0x12,%eax
 b01:	31 d0                	xor    %edx,%eax

    // Strip off uppermost bit because we want a long,
    // not an unsigned long
    return y & RAND_MAX;
 b03:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
 b08:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
 b09:	3d 71 02 00 00       	cmp    $0x271,%eax
 b0e:	0f 84 d4 00 00 00    	je     be8 <genrand+0x128>
    mt[0]= seed & 0xffffffff;
 b14:	31 c0                	xor    %eax,%eax
 b16:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 b1d:	8d 76 00             	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 b20:	8b 0c 85 a0 15 00 00 	mov    0x15a0(,%eax,4),%ecx
 b27:	83 c0 01             	add    $0x1,%eax
 b2a:	8b 14 85 a0 15 00 00 	mov    0x15a0(,%eax,4),%edx
 b31:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
 b37:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 b3d:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
 b3f:	89 d1                	mov    %edx,%ecx
 b41:	83 e2 01             	and    $0x1,%edx
 b44:	d1 e9                	shr    %ecx
 b46:	33 0c 85 d0 1b 00 00 	xor    0x1bd0(,%eax,4),%ecx
 b4d:	33 0c 95 54 0d 00 00 	xor    0xd54(,%edx,4),%ecx
 b54:	89 0c 85 9c 15 00 00 	mov    %ecx,0x159c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 b5b:	3d e3 00 00 00       	cmp    $0xe3,%eax
 b60:	75 be                	jne    b20 <genrand+0x60>
 b62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 b68:	8b 0c 85 a0 15 00 00 	mov    0x15a0(,%eax,4),%ecx
 b6f:	83 c0 01             	add    $0x1,%eax
 b72:	8b 14 85 a0 15 00 00 	mov    0x15a0(,%eax,4),%edx
 b79:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
 b7f:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 b85:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
 b87:	89 d1                	mov    %edx,%ecx
 b89:	83 e2 01             	and    $0x1,%edx
 b8c:	d1 e9                	shr    %ecx
 b8e:	33 0c 85 10 12 00 00 	xor    0x1210(,%eax,4),%ecx
 b95:	33 0c 95 54 0d 00 00 	xor    0xd54(,%edx,4),%ecx
 b9c:	89 0c 85 9c 15 00 00 	mov    %ecx,0x159c(,%eax,4)
        for (;kk<N-1;kk++) {
 ba3:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 ba8:	75 be                	jne    b68 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 baa:	8b 0d a0 15 00 00    	mov    0x15a0,%ecx
 bb0:	a1 5c 1f 00 00       	mov    0x1f5c,%eax
 bb5:	89 ca                	mov    %ecx,%edx
 bb7:	25 00 00 00 80       	and    $0x80000000,%eax
 bbc:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 bc2:	09 d0                	or     %edx,%eax
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
 bc4:	89 c2                	mov    %eax,%edx
 bc6:	83 e0 01             	and    $0x1,%eax
 bc9:	d1 ea                	shr    %edx
 bcb:	33 15 d0 1b 00 00    	xor    0x1bd0,%edx
 bd1:	33 14 85 54 0d 00 00 	xor    0xd54(,%eax,4),%edx
 bd8:	89 15 5c 1f 00 00    	mov    %edx,0x1f5c
 bde:	ba 01 00 00 00       	mov    $0x1,%edx
 be3:	e9 ee fe ff ff       	jmp    ad6 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 be8:	b8 a4 15 00 00       	mov    $0x15a4,%eax
 bed:	b9 5c 1f 00 00       	mov    $0x1f5c,%ecx
 bf2:	ba 05 11 00 00       	mov    $0x1105,%edx
 bf7:	c7 05 a0 15 00 00 05 	movl   $0x1105,0x15a0
 bfe:	11 00 00 
    for (mti=1; mti<N; mti++)
 c01:	eb 08                	jmp    c0b <genrand+0x14b>
 c03:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 c07:	90                   	nop
 c08:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
 c0b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
 c11:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 c13:	39 c1                	cmp    %eax,%ecx
 c15:	75 f1                	jne    c08 <genrand+0x148>
 c17:	e9 f8 fe ff ff       	jmp    b14 <genrand+0x54>
 c1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

00000c20 <random_at_most>:
...
long random_at_most(long max) {
 c29:	53                   	push   %ebx
    bin_size = num_rand / num_bins,
 c2a:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
 c2f:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 c32:	89 d8                	mov    %ebx,%eax
 c34:	f7 f1                	div    %ecx
 c36:	89 c6                	mov    %eax,%esi
  long x;
  do {
   x = genrand();
  }
 ...
 c38:	29 d3                	sub    %edx,%ebx
 c3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
   x = genrand();
 c40:	e8 7b fe ff ff       	call   ac0 <genrand>
  while (num_rand - defect <= (unsigned long)x);
 c45:	39 d8                	cmp    %ebx,%eax
 c47:	73 f7                	jae    c40 <random_at_most+0x20>
 ...
 c58:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 c5f:	90                   	nop

00000c60 <randomrange>:
...
int randomrange(int low, int high){
 ...
 c6c:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(high<low){
 c6f:	39 f0                	cmp    %esi,%eax
 c71:	7d 06                	jge    c79 <randomrange+0x19>
 c73:	89 f2                	mov    %esi,%edx
 c75:	89 c6                	mov    %eax,%esi
 ...
 c79:	29 f0                	sub    %esi,%eax
    bin_size = num_rand / num_bins,
 c7b:	bb 00 00 00 80       	mov    $0x80000000,%ebx
 c80:	31 d2                	xor    %edx,%edx
    num_bins = (unsigned long) max + 1,
 c82:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 c85:	89 d8                	mov    %ebx,%eax
 c87:	f7 f1                	div    %ecx
 c89:	89 c7                	mov    %eax,%edi
  while (num_rand - defect <= (unsigned long)x);
 c8b:	29 d3                	sub    %edx,%ebx
 c8d:	8d 76 00             	lea    0x0(%esi),%esi
   x = genrand();
 c90:	e8 2b fe ff ff       	call   ac0 <genrand>
  while (num_rand - defect <= (unsigned long)x);
 c95:	39 d8                	cmp    %ebx,%eax
 c97:	73 f7                	jae    c90 <randomrange+0x30>
  return x/bin_size;
 c99:	31 d2                	xor    %edx,%edx
  return val;
}
 c9b:	83 c4 0c             	add    $0xc,%esp
  return x/bin_size;
 c9e:	f7 f7                	div    %edi
}
 ca0:	5b                   	pop    %ebx
  int val = random_at_most(high-low) + low;
 ca1:	01 f0                	add    %esi,%eax
}
 ca3:	5e                   	pop    %esi
 ca4:	5f                   	pop    %edi
 ca5:	5d                   	pop    %ebp
