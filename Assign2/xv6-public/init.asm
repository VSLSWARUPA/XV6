...
main(void)
{
  ...
  ab:	68 56 0a 00 00       	push   $0xa56
  b0:	e8 c6 02 00 00       	call   37b <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 59 0a 00 00       	push   $0xa59
  bc:	6a 01                	push   $0x1
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 d8 0a 00 00 	movzbl 0xad8(%edx),%edx
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 80 0a 00 00 	jmp    *0xa80(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 78 0a 00 00       	mov    $0xa78,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 20 0e 00 00       	mov    0xe20,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 20 0e 00 00    	mov    %edx,0xe20
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 20 0e 00 00    	mov    %edx,0xe20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 20 0e 00 00    	mov    0xe20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 20 0e 00 00    	mov    0xe20,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 20 0e 00 00    	mov    0xe20,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 20 0e 00 00    	mov    %edx,0xe20
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 20 0e 00 00 24 	movl   $0xe24,0xe20
 7c7:	0e 00 00 
    base.s.size = 0;
 7ca:	bf 24 0e 00 00       	mov    $0xe24,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 24 0e 00 00 24 	movl   $0xe24,0xe24
 7d6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 28 0e 00 00 00 	movl   $0x0,0xe28
 7e2:	00 00 00 
    if(p->s.size >= nunits){
...
{
 800:	55                   	push   %ebp
 801:	b8 44 0e 00 00       	mov    $0xe44,%eax
 ...
 80b:	89 15 40 0e 00 00    	mov    %edx,0xe40
    for (mti=1; mti<N; mti++)
 811:	eb 08                	jmp    81b <sgenrand+0x1b>
 813:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 817:	90                   	nop
 818:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
 81b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
 821:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 823:	3d fc 17 00 00       	cmp    $0x17fc,%eax
 828:	75 ee                	jne    818 <sgenrand+0x18>
 82a:	c7 05 1c 0e 00 00 70 	movl   $0x270,0xe1c
 831:	02 00 00 
}
 834:	5d                   	pop    %ebp
 835:	c3                   	ret    
...
00000840 <genrand>:
{
 ...
 840:	a1 1c 0e 00 00       	mov    0xe1c,%eax
 845:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 84a:	7f 3d                	jg     889 <genrand+0x49>
    ...
    y = mt[mti++];
 84c:	8b 0c 85 40 0e 00 00 	mov    0xe40(,%eax,4),%ecx
 853:	8d 50 01             	lea    0x1(%eax),%edx
 856:	89 15 1c 0e 00 00    	mov    %edx,0xe1c
    y ^= TEMPERING_SHIFT_U(y);
 85c:	89 ca                	mov    %ecx,%edx
 85e:	c1 ea 0b             	shr    $0xb,%edx
 861:	31 ca                	xor    %ecx,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
 863:	89 d0                	mov    %edx,%eax
 865:	c1 e0 07             	shl    $0x7,%eax
 868:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
 86d:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
 86f:	89 c2                	mov    %eax,%edx
 871:	c1 e2 0f             	shl    $0xf,%edx
 874:	81 e2 00 00 c6 ef    	and    $0xefc60000,%edx
 87a:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_L(y);
 87c:	89 d0                	mov    %edx,%eax
 87e:	c1 e8 12             	shr    $0x12,%eax
 881:	31 d0                	xor    %edx,%eax

    // Strip off uppermost bit because we want a long,
    // not an unsigned long
    return y & RAND_MAX;
 883:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
 888:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
 889:	3d 71 02 00 00       	cmp    $0x271,%eax
 88e:	0f 84 d4 00 00 00    	je     968 <genrand+0x128>
    mt[0]= seed & 0xffffffff;
 894:	31 c0                	xor    %eax,%eax
 896:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 89d:	8d 76 00             	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 8a0:	8b 0c 85 40 0e 00 00 	mov    0xe40(,%eax,4),%ecx
 8a7:	83 c0 01             	add    $0x1,%eax
 8aa:	8b 14 85 40 0e 00 00 	mov    0xe40(,%eax,4),%edx
 ...
 8c4:	d1 e9                	shr    %ecx
 8c6:	33 0c 85 70 14 00 00 	xor    0x1470(,%eax,4),%ecx
 8cd:	33 0c 95 ec 0a 00 00 	xor    0xaec(,%edx,4),%ecx
 8d4:	89 0c 85 3c 0e 00 00 	mov    %ecx,0xe3c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 8db:	3d e3 00 00 00       	cmp    $0xe3,%eax
 8e0:	75 be                	jne    8a0 <genrand+0x60>
 8e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 8e8:	8b 0c 85 40 0e 00 00 	mov    0xe40(,%eax,4),%ecx
 8ef:	83 c0 01             	add    $0x1,%eax
 8f2:	8b 14 85 40 0e 00 00 	mov    0xe40(,%eax,4),%edx
 ...
 90c:	d1 e9                	shr    %ecx
 90e:	33 0c 85 b0 0a 00 00 	xor    0xab0(,%eax,4),%ecx
 915:	33 0c 95 ec 0a 00 00 	xor    0xaec(,%edx,4),%ecx
 91c:	89 0c 85 3c 0e 00 00 	mov    %ecx,0xe3c(,%eax,4)
        for (;kk<N-1;kk++) {
 923:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 928:	75 be                	jne    8e8 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 92a:	8b 0d 40 0e 00 00    	mov    0xe40,%ecx
 930:	a1 fc 17 00 00       	mov    0x17fc,%eax
 935:	89 ca                	mov    %ecx,%edx
 937:	25 00 00 00 80       	and    $0x80000000,%eax
 93c:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
 942:	09 d0                	or     %edx,%eax
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
 944:	89 c2                	mov    %eax,%edx
 946:	83 e0 01             	and    $0x1,%eax
 949:	d1 ea                	shr    %edx
 94b:	33 15 70 14 00 00    	xor    0x1470,%edx
 951:	33 14 85 ec 0a 00 00 	xor    0xaec(,%eax,4),%edx
 958:	89 15 fc 17 00 00    	mov    %edx,0x17fc
 95e:	ba 01 00 00 00       	mov    $0x1,%edx
 963:	e9 ee fe ff ff       	jmp    856 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 968:	b8 44 0e 00 00       	mov    $0xe44,%eax
 96d:	b9 fc 17 00 00       	mov    $0x17fc,%ecx
 972:	ba 05 11 00 00       	mov    $0x1105,%edx
 977:	c7 05 40 0e 00 00 05 	movl   $0x1105,0xe40
 97e:	11 00 00 
    for (mti=1; mti<N; mti++)
 981:	eb 08                	jmp    98b <genrand+0x14b>
 ...
 997:	e9 f8 fe ff ff       	jmp    894 <genrand+0x54>
...
long random_at_most(long max) {
 9a9:	53                   	push   %ebx
    bin_size = num_rand / num_bins,
 9aa:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
 9af:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 9b2:	89 d8                	mov    %ebx,%eax
 9b4:	f7 f1                	div    %ecx
...
int randomrange(int low, int high){
 ...
 9f1:	7d 06                	jge    9f9 <randomrange+0x19>
 9f3:	89 f2                	mov    %esi,%edx
 9f5:	89 c6                	mov    %eax,%esi
 ...
 9f9:	29 f0                	sub    %esi,%eax
    bin_size = num_rand / num_bins,
 9fb:	bb 00 00 00 80       	mov    $0x80000000,%ebx
 a00:	31 d2                	xor    %edx,%edx
    num_bins = (unsigned long) max + 1,
 a02:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
 a05:	89 d8                	mov    %ebx,%eax
 a07:	f7 f1                	div    %ecx
 a09:	89 c7                	mov    %eax,%edi
  while (num_rand - defect <= (unsigned long)x);
 a0b:	29 d3                	sub    %edx,%ebx
 a0d:	8d 76 00             	lea    0x0(%esi),%esi
   x = genrand();
 a10:	e8 2b fe ff ff       	call   840 <genrand>
  while (num_rand - defect <= (unsigned long)x);
 a15:	39 d8                	cmp    %ebx,%eax
 a17:	73 f7                	jae    a10 <randomrange+0x30>
  return x/bin_size;
 a19:	31 d2                	xor    %edx,%edx
  return val;
}
 a1b:	83 c4 0c             	add    $0xc,%esp
  return x/bin_size;
 a1e:	f7 f7                	div    %edi
}
 a20:	5b                   	pop    %ebx
  int val = random_at_most(high-low) + low;
 a21:	01 f0                	add    %esi,%eax
}
 a23:	5e                   	pop    %esi
 a24:	5f                   	pop    %edi
 a25:	5d                   	pop    %ebp
