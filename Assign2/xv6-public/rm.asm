 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 3e9:	0f b6 92 44 0a 00 00 	movzbl 0xa44(%edx),%edx
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 ec 09 00 00 	jmp    *0x9ec(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba e5 09 00 00       	mov    $0x9e5,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 a0 0d 00 00       	mov    0xda0,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 a0 0d 00 00    	mov    %edx,0xda0
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 a0 0d 00 00    	mov    %edx,0xda0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d a0 0d 00 00    	mov    0xda0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d a0 0d 00 00    	mov    0xda0,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 a0 0d 00 00    	mov    %edx,0xda0
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 a0 0d 00 00 a4 	movl   $0xda4,0xda0
 757:	0d 00 00 
    base.s.size = 0;
 75a:	bf a4 0d 00 00       	mov    $0xda4,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 a4 0d 00 00 a4 	movl   $0xda4,0xda4
 766:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 a8 0d 00 00 00 	movl   $0x0,0xda8
 772:	00 00 00 
    if(p->s.size >= nunits){
...
{
 790:	55                   	push   %ebp
 791:	b8 c4 0d 00 00       	mov    $0xdc4,%eax
 ...
 79b:	89 15 c0 0d 00 00    	mov    %edx,0xdc0
    for (mti=1; mti<N; mti++)
 ...
 7b1:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
 7b3:	3d 7c 17 00 00       	cmp    $0x177c,%eax
 7b8:	75 ee                	jne    7a8 <sgenrand+0x18>
 7ba:	c7 05 8c 0d 00 00 70 	movl   $0x270,0xd8c
 7c1:	02 00 00 
}
 7c4:	5d                   	pop    %ebp
 7c5:	c3                   	ret    
...
000007d0 <genrand>:
{
 ...
 7d0:	a1 8c 0d 00 00       	mov    0xd8c,%eax
 ...
 7da:	7f 3d                	jg     819 <genrand+0x49>
    ...
    y = mt[mti++];
 7dc:	8b 0c 85 c0 0d 00 00 	mov    0xdc0(,%eax,4),%ecx
 7e3:	8d 50 01             	lea    0x1(%eax),%edx
 7e6:	89 15 8c 0d 00 00    	mov    %edx,0xd8c
 ...
 830:	8b 0c 85 c0 0d 00 00 	mov    0xdc0(,%eax,4),%ecx
 837:	83 c0 01             	add    $0x1,%eax
 83a:	8b 14 85 c0 0d 00 00 	mov    0xdc0(,%eax,4),%edx
 ...
 854:	d1 e9                	shr    %ecx
 856:	33 0c 85 f0 13 00 00 	xor    0x13f0(,%eax,4),%ecx
 85d:	33 0c 95 58 0a 00 00 	xor    0xa58(,%edx,4),%ecx
 864:	89 0c 85 bc 0d 00 00 	mov    %ecx,0xdbc(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
 86b:	3d e3 00 00 00       	cmp    $0xe3,%eax
 870:	75 be                	jne    830 <genrand+0x60>
 872:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
 878:	8b 0c 85 c0 0d 00 00 	mov    0xdc0(,%eax,4),%ecx
 87f:	83 c0 01             	add    $0x1,%eax
 882:	8b 14 85 c0 0d 00 00 	mov    0xdc0(,%eax,4),%edx
 ...
 89c:	d1 e9                	shr    %ecx
 89e:	33 0c 85 30 0a 00 00 	xor    0xa30(,%eax,4),%ecx
 8a5:	33 0c 95 58 0a 00 00 	xor    0xa58(,%edx,4),%ecx
 8ac:	89 0c 85 bc 0d 00 00 	mov    %ecx,0xdbc(,%eax,4)
        for (;kk<N-1;kk++) {
 8b3:	3d 6f 02 00 00       	cmp    $0x26f,%eax
 8b8:	75 be                	jne    878 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
 8ba:	8b 0d c0 0d 00 00    	mov    0xdc0,%ecx
 8c0:	a1 7c 17 00 00       	mov    0x177c,%eax
 ...
 8d9:	d1 ea                	shr    %edx
 8db:	33 15 f0 13 00 00    	xor    0x13f0,%edx
 8e1:	33 14 85 58 0a 00 00 	xor    0xa58(,%eax,4),%edx
 8e8:	89 15 7c 17 00 00    	mov    %edx,0x177c
 8ee:	ba 01 00 00 00       	mov    $0x1,%edx
 8f3:	e9 ee fe ff ff       	jmp    7e6 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
 8f8:	b8 c4 0d 00 00       	mov    $0xdc4,%eax
 8fd:	b9 7c 17 00 00       	mov    $0x177c,%ecx
 902:	ba 05 11 00 00       	mov    $0x1105,%edx
 907:	c7 05 c0 0d 00 00 05 	movl   $0x1105,0xdc0
 90e:	11 00 00 
    for (mti=1; mti<N; mti++)
