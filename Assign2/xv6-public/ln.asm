 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 20 0a 00 00 	movzbl 0xa20(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 c8 09 00 00 	jmp    *0x9c8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba bf 09 00 00       	mov    $0x9bf,%edx
        while(*s != 0){
...
sgenrand(unsigned long seed)
{
 ...
 79a:	c7 05 5c 0d 00 00 70 	movl   $0x270,0xd5c
 7a1:	02 00 00 
}
 7a4:	5d                   	pop    %ebp
 7a5:	c3                   	ret    
...
000007b0 <genrand>:
{
 ...
 7b0:	a1 5c 0d 00 00       	mov    0xd5c,%eax
 ...
 7c6:	89 15 5c 0d 00 00    	mov    %edx,0xd5c
 ...
 83d:	33 0c 95 34 0a 00 00 	xor    0xa34(,%edx,4),%ecx
 ...
 885:	33 0c 95 34 0a 00 00 	xor    0xa34(,%edx,4),%ecx
 ...
 8c1:	33 14 85 34 0a 00 00 	xor    0xa34(,%eax,4),%edx
