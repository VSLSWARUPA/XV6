...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      40:	80 3d e2 1c 00 00 20 	cmpb   $0x20,0x1ce2
...
fork1(void)
{
  ...
  memset(buf, 0, nbuf);
      ...
      79:	6a 64                	push   $0x64
      7b:	6a 00                	push   $0x0
      7d:	68 e0 1c 00 00       	push   $0x1ce0
      82:	e8 09 0c 00 00       	call   c90 <memset>
  gets(buf, nbuf);
      87:	58                   	pop    %eax
      88:	5a                   	pop    %edx
      89:	6a 64                	push   $0x64
      8b:	68 e0 1c 00 00       	push   $0x1ce0
      90:	e8 5b 0c 00 00       	call   cf0 <gets>
  if(buf[0] == 0) // EOF
      95:	0f b6 05 e0 1c 00 00 	movzbl 0x1ce0,%eax
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a7:	80 3d e1 1c 00 00 64 	cmpb   $0x64,0x1ce1
     ...
     100:	51                   	push   %ecx
     101:	68 e3 1c 00 00       	push   $0x1ce3
     106:	68 b1 15 00 00       	push   $0x15b1
     10b:	6a 02                	push   $0x2
  ...
  exit();
    ...
    panic("fork");
     ...
     122:	68 0b 15 00 00       	push   $0x150b
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 08 15 00 00       	push   $0x1508
     143:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 a5 15 00 00       	push   $0x15a5
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 0b 15 00 00       	push   $0x150b
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 c0 15 00 00 	jmp    *0x15c0(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 17 15 00 00       	push   $0x1517
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2cf:	68 37 15 00 00       	push   $0x1537
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 bc 1c 00 00       	push   $0x1cbc
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 bc 1c 00 00       	push   $0x1cbc
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 b4 1c 00 00       	push   $0x1cb4
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 bc 1c 00 00       	push   $0x1cbc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 bc 1c 00 00       	push   $0x1cbc
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 59 15 00 00       	push   $0x1559
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 3c 15 00 00       	push   $0x153c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 5c 15 00 00       	push   $0x155c
     7a4:	57                   	push   %edi
     7a5:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 73 15 00 00       	push   $0x1573
     80b:	57                   	push   %edi
     80c:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 65 15 00 00       	push   $0x1565
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 5e 15 00 00       	push   $0x155e
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 78 15 00 00       	push   $0x1578
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 7a 15 00 00       	push   $0x157a
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 76 15 00 00       	push   $0x1576
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 5c 15 00 00       	push   $0x155c
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 98 15 00 00       	push   $0x1598
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac9:	ff 24 85 d8 15 00 00 	jmp    *0x15d8(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 26 15 00 00       	push   $0x1526
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 9a 15 00 00       	push   $0x159a
     bb5:	6a 02                	push   $0x2
     bb7:	e8 f4 03 00 00       	call   fb0 <printf>
    panic("syntax");
     bbc:	c7 04 24 5e 15 00 00 	movl   $0x155e,(%esp)
     ...
     f0c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f39:	0f b6 92 50 16 00 00 	movzbl 0x1650(%edx),%edx
     ...
     fb9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1029:	ff 24 85 f8 15 00 00 	jmp    *0x15f8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1137:	90                   	nop
          s = "(null)";
    1138:	ba f0 15 00 00       	mov    $0x15f0,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1151:	a1 44 1d 00 00       	mov    0x1d44,%eax
{
  ...
  freep = p;
    ...
    1191:	5b                   	pop    %ebx
  freep = p;
    1192:	89 15 44 1d 00 00    	mov    %edx,0x1d44
}
    1198:	5e                   	pop    %esi
    1199:	5f                   	pop    %edi
    119a:	5d                   	pop    %ebp
  ...
  freep = p;
    11cc:	89 15 44 1d 00 00    	mov    %edx,0x1d44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11ec:	8b 3d 44 1d 00 00    	mov    0x1d44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1231:	8b 3d 44 1d 00 00    	mov    0x1d44,%edi
  ...
  return freep;
    125f:	8b 15 44 1d 00 00    	mov    0x1d44,%edx
    ...
    128c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    128f:	89 15 44 1d 00 00    	mov    %edx,0x1d44
}
    ...
    129f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    12a0:	c7 05 44 1d 00 00 48 	movl   $0x1d48,0x1d44
    12a7:	1d 00 00 
    base.s.size = 0;
    12aa:	bf 48 1d 00 00       	mov    $0x1d48,%edi
    base.s.ptr = freep = prevp = &base;
    12af:	c7 05 48 1d 00 00 48 	movl   $0x1d48,0x1d48
    12b6:	1d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    12bb:	c7 05 4c 1d 00 00 00 	movl   $0x0,0x1d4c
    12c2:	00 00 00 
    if(p->s.size >= nunits){
...
{
    12e0:	55                   	push   %ebp
    12e1:	b8 64 1d 00 00       	mov    $0x1d64,%eax
    ...
    12eb:	89 15 60 1d 00 00    	mov    %edx,0x1d60
    for (mti=1; mti<N; mti++)
    12f1:	eb 08                	jmp    12fb <sgenrand+0x1b>
    12f3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    12f7:	90                   	nop
    12f8:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
    12fb:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    1301:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
    1303:	3d 1c 27 00 00       	cmp    $0x271c,%eax
    1308:	75 ee                	jne    12f8 <sgenrand+0x18>
    130a:	c7 05 c4 1c 00 00 70 	movl   $0x270,0x1cc4
    1311:	02 00 00 
}
    1314:	5d                   	pop    %ebp
    1315:	c3                   	ret    
...
00001320 <genrand>:
{
    ...
    1320:	a1 c4 1c 00 00       	mov    0x1cc4,%eax
    1325:	3d 6f 02 00 00       	cmp    $0x26f,%eax
    132a:	7f 3d                	jg     1369 <genrand+0x49>
    ...
    y = mt[mti++];
    132c:	8b 0c 85 60 1d 00 00 	mov    0x1d60(,%eax,4),%ecx
    1333:	8d 50 01             	lea    0x1(%eax),%edx
    1336:	89 15 c4 1c 00 00    	mov    %edx,0x1cc4
    y ^= TEMPERING_SHIFT_U(y);
    133c:	89 ca                	mov    %ecx,%edx
    133e:	c1 ea 0b             	shr    $0xb,%edx
    1341:	31 ca                	xor    %ecx,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
    1343:	89 d0                	mov    %edx,%eax
    1345:	c1 e0 07             	shl    $0x7,%eax
    1348:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
    134d:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
    134f:	89 c2                	mov    %eax,%edx
    1351:	c1 e2 0f             	shl    $0xf,%edx
    1354:	81 e2 00 00 c6 ef    	and    $0xefc60000,%edx
    135a:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_L(y);
    135c:	89 d0                	mov    %edx,%eax
    135e:	c1 e8 12             	shr    $0x12,%eax
    1361:	31 d0                	xor    %edx,%eax

    // Strip off uppermost bit because we want a long,
    // not an unsigned long
    return y & RAND_MAX;
    1363:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
    1368:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
    1369:	3d 71 02 00 00       	cmp    $0x271,%eax
    136e:	0f 84 d4 00 00 00    	je     1448 <genrand+0x128>
    mt[0]= seed & 0xffffffff;
    1374:	31 c0                	xor    %eax,%eax
    1376:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    137d:	8d 76 00             	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
    1380:	8b 0c 85 60 1d 00 00 	mov    0x1d60(,%eax,4),%ecx
    1387:	83 c0 01             	add    $0x1,%eax
    138a:	8b 14 85 60 1d 00 00 	mov    0x1d60(,%eax,4),%edx
    1391:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
    1397:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
    139d:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
    139f:	89 d1                	mov    %edx,%ecx
    13a1:	83 e2 01             	and    $0x1,%edx
    13a4:	d1 e9                	shr    %ecx
    13a6:	33 0c 85 90 23 00 00 	xor    0x2390(,%eax,4),%ecx
    13ad:	33 0c 95 64 16 00 00 	xor    0x1664(,%edx,4),%ecx
    13b4:	89 0c 85 5c 1d 00 00 	mov    %ecx,0x1d5c(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
    13bb:	3d e3 00 00 00       	cmp    $0xe3,%eax
    13c0:	75 be                	jne    1380 <genrand+0x60>
    13c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
    13c8:	8b 0c 85 60 1d 00 00 	mov    0x1d60(,%eax,4),%ecx
    13cf:	83 c0 01             	add    $0x1,%eax
    13d2:	8b 14 85 60 1d 00 00 	mov    0x1d60(,%eax,4),%edx
    13d9:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
    13df:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
    13e5:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
    13e7:	89 d1                	mov    %edx,%ecx
    13e9:	83 e2 01             	and    $0x1,%edx
    13ec:	d1 e9                	shr    %ecx
    13ee:	33 0c 85 d0 19 00 00 	xor    0x19d0(,%eax,4),%ecx
    13f5:	33 0c 95 64 16 00 00 	xor    0x1664(,%edx,4),%ecx
    13fc:	89 0c 85 5c 1d 00 00 	mov    %ecx,0x1d5c(,%eax,4)
        for (;kk<N-1;kk++) {
    1403:	3d 6f 02 00 00       	cmp    $0x26f,%eax
    1408:	75 be                	jne    13c8 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
    140a:	8b 0d 60 1d 00 00    	mov    0x1d60,%ecx
    1410:	a1 1c 27 00 00       	mov    0x271c,%eax
    1415:	89 ca                	mov    %ecx,%edx
    1417:	25 00 00 00 80       	and    $0x80000000,%eax
    141c:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
    1422:	09 d0                	or     %edx,%eax
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
    1424:	89 c2                	mov    %eax,%edx
    1426:	83 e0 01             	and    $0x1,%eax
    1429:	d1 ea                	shr    %edx
    142b:	33 15 90 23 00 00    	xor    0x2390,%edx
    1431:	33 14 85 64 16 00 00 	xor    0x1664(,%eax,4),%edx
    1438:	89 15 1c 27 00 00    	mov    %edx,0x271c
    143e:	ba 01 00 00 00       	mov    $0x1,%edx
    1443:	e9 ee fe ff ff       	jmp    1336 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
    1448:	b8 64 1d 00 00       	mov    $0x1d64,%eax
    144d:	b9 1c 27 00 00       	mov    $0x271c,%ecx
    1452:	ba 05 11 00 00       	mov    $0x1105,%edx
    1457:	c7 05 60 1d 00 00 05 	movl   $0x1105,0x1d60
    145e:	11 00 00 
    for (mti=1; mti<N; mti++)
    1461:	eb 08                	jmp    146b <genrand+0x14b>
    1463:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    1467:	90                   	nop
    1468:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
    146b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    1471:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
    1473:	39 c1                	cmp    %eax,%ecx
    1475:	75 f1                	jne    1468 <genrand+0x148>
    1477:	e9 f8 fe ff ff       	jmp    1374 <genrand+0x54>
    147c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

00001480 <random_at_most>:
...
long random_at_most(long max) {
    1489:	53                   	push   %ebx
    bin_size = num_rand / num_bins,
    148a:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
    148f:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
    1492:	89 d8                	mov    %ebx,%eax
    1494:	f7 f1                	div    %ecx
    1496:	89 c6                	mov    %eax,%esi
  long x;
  do {
   x = genrand();
  }
  ...
  while (num_rand - defect <= (unsigned long)x);
    1498:	29 d3                	sub    %edx,%ebx
    149a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
   x = genrand();
    14a0:	e8 7b fe ff ff       	call   1320 <genrand>
  while (num_rand - defect <= (unsigned long)x);
    14a5:	39 d8                	cmp    %ebx,%eax
    14a7:	73 f7                	jae    14a0 <random_at_most+0x20>
...
int randomrange(int low, int high){
  ...
  if(high<low){
    14cf:	39 f0                	cmp    %esi,%eax
    14d1:	7d 06                	jge    14d9 <randomrange+0x19>
    14d3:	89 f2                	mov    %esi,%edx
    14d5:	89 c6                	mov    %eax,%esi
    14d7:	89 d0                	mov    %edx,%eax
    int temp=high;
    high=low;
    low=temp;
  }
  int val = random_at_most(high-low) + low;
    14d9:	29 f0                	sub    %esi,%eax
    bin_size = num_rand / num_bins,
    14db:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    14e0:	31 d2                	xor    %edx,%edx
    num_bins = (unsigned long) max + 1,
    14e2:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
    14e5:	89 d8                	mov    %ebx,%eax
    14e7:	f7 f1                	div    %ecx
    14e9:	89 c7                	mov    %eax,%edi
  while (num_rand - defect <= (unsigned long)x);
    14eb:	29 d3                	sub    %edx,%ebx
    14ed:	8d 76 00             	lea    0x0(%esi),%esi
   x = genrand();
    14f0:	e8 2b fe ff ff       	call   1320 <genrand>
  while (num_rand - defect <= (unsigned long)x);
    14f5:	39 d8                	cmp    %ebx,%eax
    14f7:	73 f7                	jae    14f0 <randomrange+0x30>
  return x/bin_size;
    14f9:	31 d2                	xor    %edx,%edx
  return val;
}
    14fb:	83 c4 0c             	add    $0xc,%esp
  return x/bin_size;
    14fe:	f7 f7                	div    %edi
}
    1500:	5b                   	pop    %ebx
  int val = random_at_most(high-low) + low;
    1501:	01 f0                	add    %esi,%eax
}
    1503:	5e                   	pop    %esi
    1504:	5f                   	pop    %edi
    1505:	5d                   	pop    %ebp
